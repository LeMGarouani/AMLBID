...
def add_header(html:str, title="AMLBID dashboard", resize=True)->str:
...
<html lang="en">
<head>
<title style="text-align: center;" >AMLBID dashboard</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.6/styles/a11y-dark.min.css">
...
def code(code:str)->str:
    """wrap an html snippet in a <div></div>"""
    return f'<pre> <code class="python"style="border-radius: 10px;"><div  style="background-color: black;">{code}</div></code></pre>'


def modelcard(title,cmiport,cname,conceptdesc,details):
    """wrap an html snippet in a <div></div>"""
    return f"""

 <div class="card-body" style="text-align: justify;"><div><h6 style="float: left;">{cmiport}</h6><code><h6><b>{cname}</b></h6></code><i>{conceptdesc}</i></div><br><p>{details}</p></div>
