...
class ShapSummaryComponent(ExplainerComponent):
    def __init__(self, explainer, title='Shap Summary', name=None,
                    ...
                    hide_type=True, hide_cats=True, hide_index=False, hide_selector=False,
        ...
        if self.description is None: self.description = " The shap summary summarizes the shap values per feature. On the plot, you can check out for yourself which parameters were the most important. \n {} was the most important followed by {} and {}.".format(self.explainer.columns_ranked_by_shap(cats=True)[0], self.explainer.columns_ranked_by_shap(cats=True)[1], self.explainer.columns_ranked_by_shap(cats=True)[2])
                ...
                dbc.Row([
                    ...
                    make_hideable(
                        dbc.Col([dbc.Form([dbc.FormGroup([
                            dbc.Label("Sorting:", id='contributions-graph-sorting-label-'+self.name,style=dict(marginLeft= 40)),
